...
import sbs.thundercraft.co.zw.sbsfreelancer.inteface.MessageListener;
...
public class ConfirmDialog extends DialogFragment implements View.OnClickListener {
    ...
    @SuppressLint("ValidFragment")
    public ConfirmDialog(String title, String message, MessageListener messageListener) {
        this(title, message);
    ...
    public void onClick(View v) {
        ...
        if (result != -1) {
            ...
            if (messageListener != null) {
                messageListener.onDialogResult(getTargetRequestCode(), result, null);
            } else {
